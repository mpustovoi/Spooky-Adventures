...
execute if score :height: tdp.516.op matches ..0 run spreadplayers ~ ~ 0 32 under 0 false @s
execute if score :height: tdp.516.op matches 1.. run spreadplayers ~ ~ 0 32 under 32 false @s
