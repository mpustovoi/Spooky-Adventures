...
execute if score :height: tdp.516.op matches ..128 run function tdp.516:merchantsetpos_17
execute if score :height: tdp.516.op matches 129..319 run function tdp.516:merchantsetpos_28
