...
tellraw @s {"translate": "%s To change %s, run this command:\n%s\n", "color": "yellow", "with": [{"text": "[Merchant]", "color": "aqua"}, {"text": "Nether Crate Stock", "color": "light_purple"}, {"translate": "/scoreboard players set :cratetradestock2: tdp.516.op %s", "color": "white", "with": [{"text": "<times>", "color": "gray"}], "clickEvent": {"action": "suggest_command", "value": "/scoreboard players set :cratetradestock2: tdp.516.op 70"}, "hoverEvent": {"action": "show_text", "contents": {"text": "Click to copy!", "color": "yellow"}}}]}
