...
execute if score :height: tdp.516.op matches ..-32 run spreadplayers ~ ~ 0 32 under -32 false @s
execute if score :height: tdp.516.op matches -31.. run function tdp.516:merchantsetpos_20
