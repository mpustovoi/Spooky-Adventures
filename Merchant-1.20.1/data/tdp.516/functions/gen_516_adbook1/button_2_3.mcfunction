...
tellraw @a {"translate":"%s %s are now %s of Merchant spawns!\n%s","color":"yellow","with":[{"text":"[Merchant]","color":"aqua"},{"text":"Overworld Players","color":"dark_aqua"},{"text":"notified","color":"light_purple"},{"translate":"Changed by: %s","color":"gray","with":[{"selector":"@s","color":"white"}]}]}
