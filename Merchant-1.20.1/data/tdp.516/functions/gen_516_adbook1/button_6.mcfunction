...
tellraw @s {"translate": "%s To change %s, run this command:\n%s\n", "color": "yellow", "with": [{"text": "[Merchant]", "color": "aqua"}, {"text": "Item Stock", "color": "light_purple"}, {"translate": "/scoreboard players set :itemtradestock1: tdp.516.op %s", "color": "white", "with": [{"text": "<times>", "color": "gray"}], "clickEvent": {"action": "suggest_command", "value": "/scoreboard players set :itemtradestock1: tdp.516.op 30"}, "hoverEvent": {"action": "show_text", "contents": {"text": "Click to copy!", "color": "yellow"}}}]}
