...
execute if score :height: tdp.516.op matches ..288 run spreadplayers ~ ~ 0 32 under 288 false @s
execute if score :height: tdp.516.op matches 289.. run spreadplayers ~ ~ 0 32 under 319 false @s
