...
data merge entity @s {Motion:[0d,0d,0.2d],Offers:{Recipes:[]},Team:"tdp.516.traders",Tags:["tdp.504.skip","tdp.516.merchant","tdp.516.invisible","tdp.datapacks"],active_effects:[{show_particles:0b,duration:300,id:"minecraft:glowing",amplifier:0b}],CustomName:'{"translate":"entity.tdp.516.merchant","fallback":"Merchant","color":"dark_green","bold":true,"italic":false}',CustomNameVisible:0b,HandItems:[{id:"minecraft:totem_of_undying",Count:1b},{id:"minecraft:brown_banner",Count:1b,tag:{BlockEntityTag:{Patterns:[{Color:12,Pattern:"gru"},{Color:0,Pattern:"bri"},{Color:7,Pattern:"bri"},{Color:11,Pattern:"gra"},{Color:9,Pattern:"gra"},{Color:3,Pattern:"gra"},{Color:0,Pattern:"mr"},{Color:0,Pattern:"mr"},{Color:0,Pattern:"mr"},{Color:5,Pattern:"mr"}]},display:{Lore:['{"translate":"item.tdp.516.trade_banner.lore","fallback":"Is it worth it?","color":"green","italic":false}'],Name:'{"translate":"item.tdp.516.trade_banner","fallback":"Trade Banner","color":"dark_green","italic":false}'},HideFlags:32}}],HandDropChances:[0.085f,0.0f],DeathLootTable:"tdp.516:merchant1"}
