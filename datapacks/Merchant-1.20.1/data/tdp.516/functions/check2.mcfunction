...
execute if score :gen_516_adbook2.button_1: tdp.516.op matches 1 as @r[predicate=tdp.516:in_nether] at @s run function tdp.516:check2_4
schedule function tdp.516:check3 5t replace
