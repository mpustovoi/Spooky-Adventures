...
tellraw @s {"translate": "%s To change %s, run this command:\n%s\n", "color": "yellow", "with": [{"text": "[Merchant]", "color": "aqua"}, {"text": "Max Nether Llamas", "color": "light_purple"}, {"translate": "/scoreboard players set :llamas2: tdp.516.op %s", "color": "white", "with": [{"text": "<llamas>", "color": "gray"}], "clickEvent": {"action": "suggest_command", "value": "/scoreboard players set :llamas2: tdp.516.op 2"}, "hoverEvent": {"action": "show_text", "contents": {"text": "Click to copy!", "color": "yellow"}}}]}
