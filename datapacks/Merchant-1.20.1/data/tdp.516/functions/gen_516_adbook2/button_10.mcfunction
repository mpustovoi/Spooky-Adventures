...
tellraw @s {"translate": "%s To change %s, run this command:\n%s\n", "color": "yellow", "with": [{"text": "[Merchant]", "color": "aqua"}, {"text": "Nether Llama Spawn Chance", "color": "light_purple"}, {"translate": "/scoreboard players set :llamachance2: tdp.516.op %s", "color": "white", "with": [{"text": "<percentage>", "color": "gray"}], "clickEvent": {"action": "suggest_command", "value": "/scoreboard players set :llamachance2: tdp.516.op 65"}, "hoverEvent": {"action": "show_text", "contents": {"text": "Click to copy!", "color": "yellow"}}}]}
