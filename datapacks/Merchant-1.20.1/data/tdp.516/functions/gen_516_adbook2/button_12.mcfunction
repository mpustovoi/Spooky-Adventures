...
tellraw @a {"translate":"%s Default settings restored for the %s!","color":"yellow","with":[{"text":"[Merchant]","color":"aqua"},{"text":"Nether Merchant","color":"light_purple"}]}
function tdp.516:gen_516_adbook2/reset
