...
execute if score :height: tdp.516.op matches ..64 run spreadplayers ~ ~ 0 32 under 64 false @s
execute if score :height: tdp.516.op matches 65.. run function tdp.516:merchantsetpos_25
