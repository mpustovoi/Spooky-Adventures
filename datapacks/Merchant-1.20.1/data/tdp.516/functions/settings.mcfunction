...
tellraw @s {"translate":"%s You have received 3 %s!\n%s","color":"gray","with":[{"text":"[Merchant]","color":"dark_aqua"},{"translate":"%s Admin Books","color":"yellow","with":[{"text":"Merchant","color":"light_purple"}]},{"text":"Each book controls the Merchant in its respective dimension.","color":"gray","italic":true}]}
