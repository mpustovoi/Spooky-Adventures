...
execute if score :gen_516_adbook3.button_1: tdp.516.op matches 1 as @r[predicate=tdp.516:in_end] at @s run function tdp.516:check3_4
schedule function tdp.516:check 5t replace
