...
tellraw @a[predicate=tdp.516:in_nether] {"translate":"message.tdp.516.merchant_trading_nearby","fallback":"%s is trading near %s","color":"yellow","with":[{"translate":"entity.tdp.516.nether_merchant","fallback":"Nether Merchant","color":"dark_red"},{"selector":"@s"}]}
