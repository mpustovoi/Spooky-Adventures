...
execute if predicate tdp.516:llamachance2 summon minecraft:trader_llama run function tdp.516:llamas2_2
scoreboard players remove :cache: tdp.516.op 1
execute if score :cache: tdp.516.op matches 1.. run function tdp.516:llamas2
