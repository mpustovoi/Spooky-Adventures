...
execute if score :height: tdp.516.op matches ..96 run spreadplayers ~ ~ 0 32 under 96 false @s
execute if score :height: tdp.516.op matches 97.. run spreadplayers ~ ~ 0 32 under 128 false @s
