...
execute as @s[tag=tdp.516.invisible,predicate=tdp.516:visible] run function tdp.516:check_6
execute as @s[tag=!tdp.516.invisible,predicate=!tdp.516:visible] run function tdp.516:check_11
