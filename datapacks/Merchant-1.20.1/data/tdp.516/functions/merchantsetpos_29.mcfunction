...
execute if score :height: tdp.516.op matches ..160 run spreadplayers ~ ~ 0 32 under 160 false @s
execute if score :height: tdp.516.op matches 161.. run function tdp.516:merchantsetpos_31
