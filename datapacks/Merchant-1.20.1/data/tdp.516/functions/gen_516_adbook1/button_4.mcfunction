...
tellraw @s {"translate": "%s To change %s, run this command:\n%s\n", "color": "yellow", "with": [{"text": "[Merchant]", "color": "aqua"}, {"text": "Stay Time", "color": "light_purple"}, {"translate": "/scoreboard players set :staytime1: tdp.516.op %s", "color": "white", "with": [{"text": "<seconds>", "color": "gray"}], "clickEvent": {"action": "suggest_command", "value": "/scoreboard players set :staytime1: tdp.516.op 2400"}, "hoverEvent": {"action": "show_text", "contents": {"text": "Click to copy!", "color": "yellow"}}}]}
