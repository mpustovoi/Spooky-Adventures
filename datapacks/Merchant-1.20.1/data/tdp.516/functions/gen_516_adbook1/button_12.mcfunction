...
tellraw @a {"translate":"%s Default settings restored for the %s!","color":"yellow","with":[{"text":"[Merchant]","color":"aqua"},{"text":"Merchant","color":"light_purple"}]}
function tdp.516:gen_516_adbook1/reset
