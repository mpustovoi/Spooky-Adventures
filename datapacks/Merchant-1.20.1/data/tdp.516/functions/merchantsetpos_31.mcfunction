...
execute if score :height: tdp.516.op matches ..192 run spreadplayers ~ ~ 0 32 under 192 false @s
execute if score :height: tdp.516.op matches 193.. run spreadplayers ~ ~ 0 32 under 224 false @s
