...
execute as @r store result score :cantrade: tdp.516.op run loot insert ~ ~ ~ loot tdp.516:crate_trades1
execute unless score :cantrade: tdp.516.op matches 0 run function tdp.516:crate_trades1_5
