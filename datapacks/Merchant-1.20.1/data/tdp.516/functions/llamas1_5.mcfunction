...
data merge entity @s {ChestedHorse:1b,Strength:5}
loot replace entity @s horse.0 loot tdp.516:llama_items1
loot replace entity @s horse.armor loot tdp.516:llama_carpets
