...
execute if score :height: tdp.516.op matches ..256 run spreadplayers ~ ~ 0 32 under 256 false @s
execute if score :height: tdp.516.op matches 257.. run function tdp.516:merchantsetpos_36
