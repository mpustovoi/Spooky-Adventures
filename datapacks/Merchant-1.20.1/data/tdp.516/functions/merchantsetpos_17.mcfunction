...
execute if score :height: tdp.516.op matches ..32 run function tdp.516:merchantsetpos_18
execute if score :height: tdp.516.op matches 33.. run function tdp.516:merchantsetpos_23
