...
tellraw @s {"translate": "%s To change %s, run this command:\n%s\n", "color": "yellow", "with": [{"text": "[Merchant]", "color": "aqua"}, {"text": "Ender Spawn Time", "color": "light_purple"}, {"translate": "/scoreboard players set :spawntime3: tdp.516.op %s", "color": "white", "with": [{"text": "<seconds>", "color": "gray"}], "clickEvent": {"action": "suggest_command", "value": "/scoreboard players set :spawntime3: tdp.516.op 12000"}, "hoverEvent": {"action": "show_text", "contents": {"text": "Click to copy!", "color": "yellow"}}}]}
