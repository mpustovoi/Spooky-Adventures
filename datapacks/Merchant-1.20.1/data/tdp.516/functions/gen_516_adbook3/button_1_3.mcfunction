...
tellraw @a {"translate":"%s Merchant can now %s in %s!\n%s","color":"yellow","with":[{"text":"[Merchant]","color":"aqua"},{"text":"spawn","color":"light_purple"},{"text":"the End","color":"dark_aqua"},{"translate":"Changed by: %s","color":"gray","with":[{"selector":"@s","color":"white"}]}]}
